...
public class ProductsController implements Serializable {
    ...
    @EJB
    private facades.ProductsFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    private String[] productPriorities = {"0", "1", "2"};
    ...
    public String[] getProductPriorities() {
        return productPriorities;
    }

    public void setProductPriorities(String[] productPriorities) {
        this.productPriorities = productPriorities;
    }
